...
! function() {
	...
	var o = function() {
		this._volume = 1, this._muted = !1, this.usingWebAudio = n, this.noAudio = r, this._howls = []
	};
	o.prototype = {
		volume: function(e) {
			var t = this;
	...
	if(!r) {
		...
		var f = {
			...
			mp4: !!(a.canPlayType("audio/x-mp4;") || a.canPlayType("audio/aac;")).replace(/^no$/, ""),
	...
	if(l.prototype = {
			load: function() {
				...
				for(var i = 0; i < t._urls.length; i++) {
					...
					if(t._format) s = t._format;
						...
						if(o = t._urls[i].toLowerCase().split("?")[0], s = o.match(/.+\.([^?]+)(\?|$)/), s = s && s.length >= 2 ? s : o.match(/data\:audio\/([^?]+);/), !s) return t.on("loaderror"), void 0;
						s = s[1]
					}
					if(f[s]) {
						n = t._urls[i];
				...
				if(t._src = n, t._webAudio) c(t, n);
					...
					var l = function() {
						t._duration = Math.ceil(10 * a.duration) / 10, 0 === Object.getOwnPropertyNames(t._sprite).length && (t._sprite = {
				...
				return "function" == typeof e && (n = e), e && "function" != typeof e || (e = "_default"), r._loaded ? r._sprite[e] ? (r._inactiveNode(function(i) {
					...
					if(function() {
							...
							s = setTimeout(function() {
								!r._webAudio && f && r.stop(t.id, t.timer).play(e, t.id), r._webAudio && !f && (r._nodeById(t.id).paused = !0, r._nodeById(t.id)._pos = 0), r._webAudio || f || r.stop(t.id, t.timer), r.on("end", l)
			...
			pause: function(e, t) {
				...
				if(r)
					if(r._pos = n.pos(null, e), n._webAudio) {
						if(!r.bufferSource || r.paused) return n;
			...
			unload: function() {
				for(var t = this, n = t._audioNode, r = 0; r < t._audioNode.length; r++) n[r].paused || t.stop(n[r].id), t._webAudio ? n[r].disconnect(0) : n[r].src = "";
				var i = u._howls.indexOf(t);
				null !== i && i >= 0 && u._howls.splice(i, 1), delete e[t._src], t = null
			}
	...
	}), "undefined" != typeof exports && (exports.Howler = u, exports.Howl = l), window.Howler = u, window.Howl = l
}()